	...
	tilecoll WALL, WALL, WALL, WATERFALL ; 22
	tilecoll WALL, WALL, WATERFALL, WALL ; 23
	...
	tilecoll WATERFALL, WALL, FLOOR, FLOOR ; 83
	tilecoll HEADBUTT_TREE, WALL, WALL, WALL ; 84
	tilecoll CAVE, WALL, WATERFALL, WALL ; 85
