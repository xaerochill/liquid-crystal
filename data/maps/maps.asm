...
MapGroup_Pewter:
	...
	map PewterMuseum1F, TILESET_GATE, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseum2F, TILESET_GATE, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map SafariZoneFuchsiaGate, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_DRATINI
	map SafariZoneBeta, TILESET_FOREST, CAVE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
	map SafariZoneCenter, TILESET_FOREST, CAVE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
	map SafariZoneEast, TILESET_FOREST, CAVE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
	map SafariZoneNorth, TILESET_FOREST, CAVE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
	map SafariZoneWest, TILESET_FOREST, CAVE, LANDMARK_FUCHSIA_CITY, MUSIC_EVOLUTION, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
