...
GoldenrodDeptStoreRoof_MapEvents:
	...
	object_event  5,  3, SPRITE_TEACHER_F, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreRoofTeacherScript, EVENT_GOLDENROD_SALE_OFF
